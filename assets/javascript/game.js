$(document).ready(function () {
    ...
    buttonarray = ["Cat", "Dog", "Fish", "Mouse", "Fox", "Rabit", "Skunk", "Bird", "Chicken", "Goldfish", "Lion", "Tigar", "deer"]
    ...
    function displaygif() {
        ...
        var queryURL = "http://api.giphy.com/v1/gifs/search?q=" + buttonname + "&api_key=dc6zaTOxFJmzC&limit=10";
        ...
        $.ajax({
            ...
            for (var i = 0; i < response.data.length; i++) {
                ...
                // $("#rating").append(ratingdiv);

                var gifimage = $("<img>");
                gifimage.attr("Rating : " + response.data[i].rating);
